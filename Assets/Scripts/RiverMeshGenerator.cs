...
public class RiverMeshGenerator : MonoBehaviour
{
    ...
    public string SavePath = "Temp/ParameterizedRiver";
    ...
    void GenerateRivermesh()
    {
        ...
        foreach (var riverPath in riverEndPathList)
        {
            ...
            PathTool.DrawToArray(ref parameterizedMap, pointList);
        ...
        PCGNode.PackNode.SaveTexture2D(PCGNode.PackNode.Pack(parameterizedMap, width), SavePath);
